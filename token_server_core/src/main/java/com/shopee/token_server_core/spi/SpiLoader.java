 ...
 */
package com.shopee.token_server_core.spi;
...
public final class SpiLoader<S> {
    ...
    public S loadInstance(String aliasName) {
        Assert.notNull(aliasName, "aliasName cannot be empty");
...
//        }
        ...
        if (urls == null || !urls.hasMoreElements()) {
            logger.warn("No SPI configuration file, filename=" + fullFileName + ", classloader=" + classLoader);
            return;
        }
        ...
        while (urls.hasMoreElements()) {
            ...
            try {
                ...
                while ((line = br.readLine()) != null) {
                    ...
                    logger.info("[SpiLoader] Found SPI implementation for SPI {}, provider={}, aliasName={}"
